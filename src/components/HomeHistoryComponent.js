...
function HomeHistoryComponent({ contents }) {
    ...
    return (
        <>
            <div ref={homeContainerRef} style={{ marginLeft: '50px' }}>
                <h1 style={{ color: 'white', fontFamily: 'NetflixSansLite', position: 'sticky', top: '90px', zIndex: '100', paddingTop: '10px' }}>Watch History</h1>
                <br></br>
